package it.macgood.mathanapp.ui.guidebook.remark
...
import it.macgood.mathanapp.databinding.FragmentRemarkBinding
...
class RemarkFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.buttonBack.setOnClickListener{
            ...
            navController.navigate(R.id.get_guidebook_from_remark)

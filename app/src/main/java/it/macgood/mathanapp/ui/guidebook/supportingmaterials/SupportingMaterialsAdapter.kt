...
import it.macgood.mathanapp.databinding.ItemSuppotringMaterialBinding
    ...
    class MaterialViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(material: Material) = with(binding) {
            ...
            binding.material.setOnClickListener {
                downloadImage(
                    url = Constants.CLOUD_STORAGE_URL + material.url,
                    outputFileName = material.name + " - " + material.author + "pdf",
